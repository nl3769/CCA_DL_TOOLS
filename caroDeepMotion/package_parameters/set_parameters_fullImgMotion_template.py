...
def setParameters():
    ...
    p=Parameters(
        MODEL_NAME='raft',
        PRES='/run/media/laine/DISK/PROJECTS_IO/MOTION/NETWORK_TRAINING/RAFT_PRETRAINED_FLYINGCHAIR_10_PX_FINE_TUNING',
        PSAVE='/run/media/laine/DISK/PROJECTS_IO/MOTION/PREDICTION/DL_METHOD_FULL_IMAGES',
        PDATA='/run/media/laine/DISK/PROJECTS_IO/MOTION/IN_SILICO/REAL_DATA/prepared_data_IMAGENET',
        DROPOUT=0,
        CORRELATION_LEVEL=4,
