function make_figure_2D_scatt(data_scatt, param, substr)
    ...
    scatter([data_scatt.x_scatt(idx); data_scatt.x_min; data_scatt.x_max]*1e3, ...
            [-data_scatt.z_scatt(idx); -data_scatt.z_min; -data_scatt.z_min]*1e3, ...
            30, ...
            [data_scatt.RC_scatt(idx); 0; 0], ...
            'filled');
