...
if __name__ == '__main__':
    ...
    path_shell = '/sps/creatis/nlaine/REPO/carotid_US_DL_tool/SIMULATION/shell_scripts/IN2P3_run_full_pipeline.sh'
    fname = '/sps/creatis/nlaine/PROJECTS_IO/RESULTS/HEALTHY_ANDRE_57'
