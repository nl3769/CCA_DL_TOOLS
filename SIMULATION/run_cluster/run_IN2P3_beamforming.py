...
if __name__ == '__main__':
    ...
    ''' execute le code sur l'IN2P3 pour un plusieurs fantomes contenu dans un même répertoire. '''

    path_shell = '/home/laine/REPOSITORIES/carotid_US_DL_tool/SIMULATION/shell/run_BF.sh'
    fname = '/home/laine/PROJECTS_IO/SIMULATION/TEST_28_02_2022'
