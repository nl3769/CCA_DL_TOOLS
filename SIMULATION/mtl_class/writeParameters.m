classdef writeParameters < handle 
    ...
    methods
        ...
        function obj=writeParameters()
            ...
            obj.param.bandwidth = 93;
            obj.param.fnumber = 1;                          % fnumber (used for apodization (emite en receive apod)
            obj.param.Nactive = 64;               
            obj.param.Nelements = 192;
            obj.param.fsCoef = 6;                             % sampling frequency -> fs=fsCoef*fc
            ...
            obj.param.dynamic_focusing = 0;                 % dynamic focus using field only
