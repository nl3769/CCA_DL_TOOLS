...
PYTHONPATH=$WD python package_cores/run_computeCompression.py -param set_parameters_computeCompression_seg_caroSegDeep-GAN-with_fine_tuning.py
...
PYTHONPATH=$WD python package_cores/run_computeCompression.py -param set_parameters_computeCompression_seg_caroSegDeep-SIMULATED-with_fine_tuning.py
