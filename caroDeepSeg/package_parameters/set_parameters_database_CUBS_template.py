...
def setParameters():
    ...
    p=Parameters(
        PDATA='/run/media/laine/DISK/PROJECTS_IO/DATA/CUBS_DATASET_for_CREATIS',                                        # PATH TO LOAD DATA
        PRES='/run/media/laine/DISK/PROJECTS_IO/SEGMENTATION/REFERENCES',                                               # PATH TO SAVE DATABASE
