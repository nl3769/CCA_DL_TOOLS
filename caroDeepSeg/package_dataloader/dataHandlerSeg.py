        ...
        for patient in path:
            ...
            for id_seq in seq:
                ...
                for fpath in path_['I1']:
                    self.image_list.append([os.path.join(patient, id_seq, 'I1', fpath)])
                    self.image_list.append([os.path.join(patient, id_seq, 'I2', fpath)])
                    self.mask_list.append([os.path.join(patient, id_seq, 'M1', fpath)])
                    self.mask_list.append([os.path.join(patient, id_seq, 'M2', fpath)])
                    self.CF_list.append([os.path.join(patient, id_seq, 'CF.txt')])
                    self.CF_list.append([os.path.join(patient, id_seq, 'CF.txt')])
    ...
    def __init__(self, param, set):
        ...
        for patient in path:
            ...
            for fpath in path_['I']:
                self.image_list.append([os.path.join(patient, 'I', fpath)])
                self.mask_list.append([os.path.join(patient, 'M', fpath)])
                self.CF_list.append([os.path.join(patient, 'CF.txt')])
