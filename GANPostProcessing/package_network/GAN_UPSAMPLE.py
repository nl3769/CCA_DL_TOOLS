...
class GeneratorUNetUPSAMPLE(nn.Module):
    def __init__(self, p, in_channels=1, out_channels=1):
        super(GeneratorUNetUPSAMPLE, self).__init__()
...
class UNetUp(nn.Module):
    ...
    def __init__(self, in_size, out_size, p):
        ...
        self.conv2d1 = nn.Conv2d(in_size, out_size, kernel_size=p.KERNEL_SIZE, stride=1, padding="same")
